...
public class MainActivity extends AppCompatActivity {
    ...
    private Button droneUp, droneDown;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        droneUp = (Button) findViewById(R.id.btnUp);
        droneDown = (Button) findViewById(R.id.btnDown);
    ...
    public void buttonClick(View view) {
        ...
        if (ipAddress.getText().toString().equals(""))
            ...
            requestTask.execute(droneStatus);
        }
    }
    ...
    private class HttpRequestTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String val = params[0];
            final String url = "http://" + serverAdress + "/drone/" + val;
